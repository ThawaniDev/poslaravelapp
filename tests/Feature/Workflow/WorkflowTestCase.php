...
abstract class WorkflowTestCase extends TestCase
{
    protected const ALL_PERMISSIONS = [
        ...
        'cashier_performance.manage_badges','cashier_performance.manage_settings',
        'cashier_performance.view_anomalies','cashier_performance.view_badges',
        'cashier_performance.view_leaderboard','cashier_performance.view_reports',

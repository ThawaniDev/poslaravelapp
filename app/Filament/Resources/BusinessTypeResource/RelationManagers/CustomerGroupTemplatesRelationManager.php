...
class CustomerGroupTemplatesRelationManager extends RelationManager
{
    ...
    {
        return __('Customer Group Templates');
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('payment_terms_days')->label(__('Terms (days)')),
                Tables\Columns\IconColumn::make('is_default_group')->boolean()->label(__('Default')),

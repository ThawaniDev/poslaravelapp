            ...
            'order' => [
                ...
                'events' => [
                    ...
                    'order.new_external' => [
                        ...
                        'description_ar' => 'طلب جديد من منصة التوصيل',
                        'default_recipients' => 'Store owner, active cashier',
                    ...
                    'order.status_changed' => [
                        ...
                        'description_ar' => 'تغيير حالة الطلب',
                    ...
                    'order.refund_approved' => [
                        ...
                        'description_ar' => 'تمت معالجة الاسترداد',
                        'default_recipients' => 'Store owner, cashier',
                        'variables' => ['order_id', 'amount', 'store_name'],
                        'is_critical' => false,
                    ],
            ...
            'inventory' => [
                ...
                'events' => [
                    'inventory.low_stock' => [
                        ...
                        'description_ar' => 'المنتج أقل من حد إعادة الطلب',
                    ...
                    'inventory.expiry_warning' => [
                        ...
                        'description_ar' => 'المنتج يقترب من تاريخ الانتهاء',
                        'default_recipients' => 'Store owner',
                    ...
                    'inventory.excess_stock' => [
                        ...
                        'description_ar' => 'المخزون يتجاوز الحد الأقصى',
                        'default_recipients' => 'Store owner',
                    ...
                    'inventory.adjustment' => [
                        ...
                        'description_ar' => 'تعديل يدوي على المخزون',
                        'default_recipients' => 'Store owner',
            ...
            'finance' => [
                ...
                'events' => [
                    'finance.daily_summary' => [
                        ...
                        'description_ar' => 'ملخص نهاية اليوم',
                        'default_recipients' => 'Store owner',
                    ...
                    'finance.shift_closed' => [
                        ...
                        'description_ar' => 'تقرير نهاية الوردية',
                        'default_recipients' => 'Store owner',
                    ...
                    'finance.large_transaction' => [
                        ...
                        'description_ar' => 'معاملة ذات قيمة عالية',
                        'default_recipients' => 'Store owner',
            ...
            'system' => [
                ...
                'events' => [
                    'system.offline_mode' => [
                        ...
                        'description_ar' => 'نقطة البيع انقطع اتصالها',
                        'default_recipients' => 'Store owner',
                    ...
                    'system.sync_failed' => [
                        ...
                        'description_ar' => 'خطأ في المزامنة',
                        'default_recipients' => 'Store owner',
                    ...
                    'system.printer_error' => [
                        ...
                        'description_ar' => 'الطابعة غير متصلة',
                    ...
                    'system.update_available' => [
                        ...
                        'description_ar' => 'تحديث جديد لنقطة البيع',
                        'default_recipients' => 'Store owner',
                    ...
                    'system.license_expiring' => [
                        ...
                        'description_ar' => 'الاشتراك على وشك الانتهاء',
                        'default_recipients' => 'Store owner',
            ...
            'staff' => [
                ...
                'events' => [
                    'staff.login' => [
                        ...
                        'description_ar' => 'تسجيل دخول موظف',
                        'default_recipients' => 'Store owner',
                    ...
                    'staff.unauthorized_access' => [
                        ...
                        'description_ar' => 'محاولة وصول غير مصرح بها',
                        'default_recipients' => 'Store owner',
                    ...
                    'staff.discount_applied' => [
                        ...
                        'description_ar' => 'خصم يتجاوز الحد المسموح',
                        'default_recipients' => 'Store owner',
                    ...
                    'staff.void_transaction' => [
                        ...
                        'description_ar' => 'تم إلغاء المعاملة',
                        'default_recipients' => 'Store owner',

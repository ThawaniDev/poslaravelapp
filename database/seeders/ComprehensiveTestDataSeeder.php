    ...
    private function seedSubscriptionExtras(): void
    {
        ...
        if ($this->proPlanId) {
            DB::table('pricing_page_content')->insertOrIgnore([
                ...
                'feature_bullet_list' => json_encode(['Up to 5,000 products', '20 staff members', '5 branches', 'Full API access', 'Priority support']),
                'faq' => json_encode([['q' => 'Can I upgrade anytime?', 'a' => 'Yes, upgrades are instant.']]),
                'created_at' => now(), 'updated_at' => now(),
            ]);
        }

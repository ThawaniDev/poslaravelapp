...
class SubscriptionPlanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->command?->info('✓ Plans seeded: Starter (99), Professional (299), Enterprise (699), Small Supermarket (149, hidden) + 12 add-ons + pricing page content.');
    }
    ...
    private function createPlans(): array
    {
        return [
            ...
            // ── Small Supermarket (hidden / partner plan) ─────────────────────
            // Sold directly to small grocery / supermarket owners.
            // hide_from_public   = true  → not shown on the public pricing page.
            // hide_unselected_features = true → disabled features are hidden from
            //   the sidebar entirely (not shown as locked), for a cleaner UI.
            [

...
return new class extends Migration
{
    ...
    {
        // 1. Add display_name_ar and description columns to permissions table
        Schema::table('permissions', function (Blueprint $table) {
            if (!Schema::hasColumn('permissions', 'display_name_ar')) {
            ...
            if (!Schema::hasColumn('permissions', 'sort_order')) {
                $table->integer('sort_order')->default(0)->after('requires_pin');
            }
        });

        // 2. Add display_name_ar and description to roles table
        ...
        // 3. Seed all comprehensive permissions
    ...
    public function down(): void
    {
        // Remove new columns
        Schema::table('permissions', function (Blueprint $table) {
            $cols = ['display_name_ar', 'description', 'description_ar', 'sort_order'];
            foreach ($cols as $col) {
        ...
        Schema::table('roles', function (Blueprint $table) {
            $cols = ['display_name_ar', 'description_ar'];
            foreach ($cols as $col) {

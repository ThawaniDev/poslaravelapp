...
return [
    ...
    'softpos_no_edfapay_token' => 'لا يمكن تفعيل SoftPOS: رمز جهاز EdfaPay غير مُعد.',
    ...
    'softpos_section_desc'  => 'إعداد مزود SoftPOS. اختر المزود أولاً ثم أدخل بيانات الاعتماد الخاصة به.',
    'softpos_provider'      => 'مزود SoftPOS',
    'softpos_provider_helper' => 'حدد حزمة SDK التي يستخدمها هذا الجهاز.',
    'provider_nearpay'      => 'NearPay',
    'provider_edfapay'      => 'EdfaPay',
    'nearpay_tid'           => 'معرف جهاز NearPay (TID)',
    'nearpay_tid_helper'    => 'يُعطى من NearPay أثناء تأهيل الجهاز.',
    'nearpay_mid'           => 'معرف التاجر (MID)',
    'nearpay_mid_helper'    => 'معرف التاجر الصادر عن NearPay.',
    'edfapay_token'         => 'رمز جهاز EdfaPay',
    'edfapay_token_helper'  => 'رمز SDK للجهاز من بوابة EdfaPay. يُحفظ مشفراً.',
    'edfapay_token_updated_at' => 'آخر تحديث للرمز',

...
return [
    ...
    'field_softpos_free_eligible_helper'         => 'عند التفعيل، ستحصل المتاجر التي تصل إلى حد حجم المبيعات على هذه الخطة مجاناً',
    'field_softpos_free_threshold_amount'        => 'حد حجم المبيعات',
    'field_softpos_free_threshold_amount_helper' => 'إجمالي مبيعات SoftPOS المطلوب (مثلاً 10,000 ريال) لفتح المستوى المجاني',
    'field_softpos_free_threshold'               => 'حد عدد المعاملات (قديم)',
    'field_softpos_free_threshold_helper'        => 'اختياري كاحتياطي: عدد معاملات SoftPOS المطلوبة عند عدم تحديد حد لحجم المبيعات',
    'field_softpos_free_threshold_period'        => 'فترة الحد',
    'field_softpos_free_threshold_period_helper' => 'الإطار الزمني الذي يجب الوصول إلى الحد خلاله',
    'period_monthly'                             => 'شهري',

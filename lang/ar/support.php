...
return [
    ...
    // ═══════════════════════════════════════════════════════════
    //  مفاتيح واجهة المستخدم المفقودة
    // ═══════════════════════════════════════════════════════════
    'ticket_info'              => 'معلومات التذكرة',
    'ticket_details_desc'      => 'أدخل التفاصيل أدناه لإنشاء أو تحديث تذكرة الدعم.',
    'internal_note_help'       => 'الملاحظات الداخلية مرئية فقط لموظفي الدعم وليس للمزود.',
    'escalated_note'           => 'تم تصعيد هذه التذكرة إلى أولوية حرجة.',
    'no_response_yet'          => 'لا يوجد رد بعد',
    'submitted_by'             => 'قدّم بواسطة',
    'messages'                 => 'الرسائل',
    'message'                  => 'الرسالة',
    'assign_to_agent'          => 'تعيين إلى موظف',
    'bulk_assign'              => 'تعيين المحدد',
    'bulk_close'               => 'إغلاق المحدد',
    'bulk_change_priority'     => 'تغيير الأولوية',
    'close'                    => 'إغلاق',
    'unassigned'               => 'غير مُعيَّن',
    'priority_updated'         => 'تم تحديث الأولوية بنجاح.',
    'satisfaction_rating'      => 'تقييم الرضا',
    'satisfaction_comment'     => 'تعليق الرضا',
    'reply_sent'               => 'تم إرسال الرد بنجاح.',
    'ticket_escalated'         => 'تم تصعيد التذكرة إلى الأولوية الحرجة.',
    'tickets_closed'           => 'تم إغلاق التذاكر المحددة بنجاح.',
    'draft_articles'           => 'مقالات المسودة',
    'ticket_count'             => 'عدد التذاكر',
    'resolution_time'          => 'وقت الحل',
    'sla_compliance'           => 'الامتثال لمستوى الخدمة',
];

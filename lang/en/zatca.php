...
return [
    ...
    'clone_from_store' => 'Clone From Another Store',
    'clone_from_store_help' => 'Copy ZATCA tax identity (VAT, CRN, business name, address) and integration preferences from another store in the same organization. The certificate, keypair and OTP are NOT cloned — each store still needs its own enrollment because ZATCA tracks the invoice counter (ICV) and hash chain (PIH) per certificate.',
    'source_store' => 'Source Store',
    'source_store_help' => 'Only stores in the same organization (or sharing the same VAT) with existing ZATCA configuration are listed.',
    'clone_succeeded' => 'Settings cloned',
    'clone_failed' => 'Clone failed',
    'clone_source_empty' => 'The selected source store has no ZATCA configuration to copy.',
    'clone_next_step' => 'Now click Enroll Now to issue this store its own CCSID/PCSID.',
    ...
    // ── Filament resource field labels (missing) ────────────────────
    'ccsid'                     => 'CCSID',
    'pcsid'                     => 'PCSID',
    'icv'                       => 'ICV',
    'pih'                       => 'PIH',
    ...
    'environment_help'          => 'developer-portal = stub QA · simulation = ZATCA simulation server · production = live ZATCA',
    'api_url'                   => 'ZATCA API URL',
    'otp_help_portal'           => 'Get OTP from https://fatoora.zatca.gov.sa → EGS Units → Add Device. Use 123321 for developer-portal only.',
    'env_scope_help'            => 'This is stored on the certificate. Each store can be on a different environment independently of the server .env.',
    'compliance_run_all'        => 'Run All 6 Compliance Tests',
    'get_production_cert'       => 'Get Production Certificate (PCSID)',
    'b2b_credit_debit_label'    => 'B2B (for Credit/Debit notes)',
    'b2b_subtype_help'          => 'ON = Standard B2B subtype, OFF = Simplified B2C',
    'including_vat'             => 'Including VAT',
    'notif_cert_issued'         => 'Production certificate issued',
    'notif_cert_body'            => 'PCSID: :pcsid\nExpires: :expires',
    'compliance_failed'          => '❌ Failed: :label',
    'notif_pcsid_failed'        => 'PCSID issuance failed',
    'hash'                      => 'Hash',

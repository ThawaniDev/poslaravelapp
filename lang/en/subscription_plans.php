...
return [
    ...
    'section_softpos_free_desc'                  => 'Make this plan free for stores that reach a SoftPOS sales-volume threshold',
    'field_softpos_free_eligible'                => 'SoftPOS Free Eligible',
    'field_softpos_free_eligible_helper'         => 'When enabled, stores reaching the sales-volume threshold will get this plan for free',
    'field_softpos_free_threshold_amount'        => 'Sales Volume Threshold',
    'field_softpos_free_threshold_amount_helper' => 'Total SoftPOS sales amount (e.g. 10,000 SAR) required to unlock free tier',
    'field_softpos_free_threshold'               => 'Transaction Count Threshold (legacy)',
    'field_softpos_free_threshold_helper'        => 'Optional fallback: number of SoftPOS transactions required when no sales-volume threshold is set',
    'field_softpos_free_threshold_period'        => 'Threshold Period',
    'field_softpos_free_threshold_period_helper' => 'The time window in which the threshold must be reached',

...
<div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-3 mt-4 flex-wrap">
                    ...
                    @if($record->is_featured)
                        <span class="px-2 py-1 rounded text-xs font-medium bg-amber-100 text-amber-800">Featured</span>
                    @endif
                    @if($record->is_verified)
                        <span class="px-2 py-1 rounded text-xs font-medium bg-blue-100 text-blue-800">Verified</span>
                    @endif
    ...
    @if(count($images) > 0)
        <div class="bg-white rounded-xl shadow p-6">
            <h2 class="font-semibold text-gray-900 mb-4">Screenshots</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="md:col-span-2 bg-white rounded-xl shadow p-6">
            ...
            <div class="prose prose-sm text-gray-600 max-w-none">
                {!! nl2br(e($record->description ?? 'No description available.')) !!}
            </div>
            @if($record->description_ar)
                <div class="mt-4 pt-4 border-t">
                    <h3 class="text-sm font-medium text-gray-500 mb-2">Arabic Description</h3>
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow p-4">
                <h3 class="text-sm font-medium text-gray-500 mb-2">Publisher</h3>
            ...
            @if($record->demo_video_url)
                <div class="bg-white rounded-xl shadow p-4">
                    <h3 class="text-sm font-medium text-gray-500 mb-2">Demo Video</h3>
            ...
            @if($record->changelog)
                <details class="bg-white rounded-xl shadow p-4">
                    <summary class="text-sm font-medium text-gray-500 cursor-pointer">Changelog</summary>

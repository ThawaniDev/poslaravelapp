        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
            @if ($cert)
                <div class="rounded-xl border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
                    ...
                    <dl class="text-sm space-y-1">
                        ...
                        <div class="flex justify-between"><dt class="text-gray-500">CCSID</dt><dd class="font-mono text-xs">{{ \Illuminate\Support\Str::limit($cert->ccsid, 24) }}</dd></div>
            ...
            @if ($device)
                <div class="rounded-xl border border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-gray-900">
                    ...
                    <dl class="text-sm space-y-1">
                        <div class="flex justify-between"><dt class="text-gray-500">UUID</dt><dd class="font-mono text-xs">{{ \Illuminate\Support\Str::limit($device->device_uuid, 24) }}</dd></div>
                        ...
                        <div class="flex justify-between"><dt class="text-gray-500">ICV</dt><dd>{{ $device->current_icv ?? 0 }}</dd></div>

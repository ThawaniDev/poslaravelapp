...
<x-filament-panels::page>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.stores') }}</p>
        ...
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.connected') }}</p>
        ...
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.healthy') }}</p>
        ...
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.tampered') }}</p>
        ...
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.invoices') }}</p>
        ...
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.accepted') }}</p>
        ...
        <x-filament::section>
            <div class="text-center">
                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('zatca.rejected') }}</p>
    ...
    {{-- Per-Store Table --}}
    <x-filament::section>
        <x-slot name="heading">{{ __('zatca.stores_breakdown') }}</x-slot>

        @if (empty($stores))
            <p class="text-gray-500 text-center py-8">{{ __('zatca.no_stores') }}</p>
        @else
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 dark:bg-gray-800">
                        <tr>
                            <th class="text-left px-3 py-2">{{ __('zatca.store') }}</th>
                            <th class="text-left px-3 py-2">{{ __('zatca.environment') }}</th>
                            <th class="text-center px-3 py-2">{{ __('zatca.connected') }}</th>
                            <th class="text-center px-3 py-2">{{ __('zatca.healthy') }}</th>
                            <th class="text-right px-3 py-2">{{ __('zatca.queue') }}</th>
                            <th class="text-right px-3 py-2">{{ __('zatca.invoices') }}</th>
                            <th class="text-right px-3 py-2">{{ __('zatca.accepted') }}</th>
                            <th class="text-right px-3 py-2">{{ __('zatca.rejected') }}</th>
                            <th class="text-right px-3 py-2">{{ __('zatca.success_rate') }}</th>
                            <th class="text-right px-3 py-2">{{ __('zatca.cert_expiry') }}</th>
                        </tr>
                    </thead>

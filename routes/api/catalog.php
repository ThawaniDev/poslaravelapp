...
Route::prefix('catalog')->middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('products')->group(function () {
        ...
        Route::post('/bulk-import', [ProductController::class, 'bulkImport'])->middleware(['permission:products.import', 'plan.feature:bulk_import', 'plan.limit:products']);
        Route::post('/import-preview', [ProductController::class, 'importPreview'])->middleware(['permission:products.import', 'plan.feature:bulk_import']);
        ...
        Route::put('/{product}/variants', [ProductController::class, 'syncVariants'])->middleware(['permission:products.manage', 'plan.feature:product_variants']);
        Route::get('/{product}/modifiers', [ProductController::class, 'modifiers'])->middleware('permission:products.view');
        Route::put('/{product}/modifiers', [ProductController::class, 'syncModifiers'])->middleware(['permission:products.manage', 'plan.feature:product_modifiers']);
        ...
        Route::put('/{product}/suppliers', [ProductController::class, 'syncSuppliers'])->middleware(['permission:products.manage_suppliers', 'plan.feature:supplier_management']);
        Route::get('/{product}/combo', [ProductController::class, 'combo'])->middleware('permission:products.view');
        Route::put('/{product}/combo', [ProductController::class, 'syncCombo'])->middleware(['permission:products.manage', 'plan.feature:combo_products']);
    ...
    // ─── Suppliers ───────────────────────────────────────────
    Route::prefix('suppliers')->middleware(['permission:products.manage_suppliers', 'plan.feature:supplier_management'])->group(function () {
